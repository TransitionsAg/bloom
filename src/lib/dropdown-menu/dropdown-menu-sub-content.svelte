...
{#if customChild}
  <DropdownMenu.SubContent {...restProps} child={customChild} forceMount={forceMountProp} class={variants({ class: className })} />
{:else}
  <DropdownMenu.SubContent {...restProps} {forceMount} class={variants({ class: className })}>
