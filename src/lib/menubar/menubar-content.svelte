<script lang="ts" module>
  ...
  export type Props = ComponentProps<typeof Menubar.Content>
</script>
...
{#if customChild}
  <Menubar.Content {...restProps} child={customChild} forceMount={forceMountProp} class={variants({ class: className })} />
{:else}
  <Menubar.Content {...restProps} {forceMount} class={variants({ class: className })}>
